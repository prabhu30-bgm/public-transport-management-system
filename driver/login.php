...
<head>
    ...
    <title>Driver Login - Bus Management System</title>
    <!-- Bootstrap CSS -->
        ...
        <div class="login-card">
            ...
            <div class="login-body">
                <div class="text-center mb-4">
                    <div class="driver-logo-wrapper">
                        <div class="driver-logo">
                            <i class="fas fa-id-card"></i>
                        </div>
                    </div>
                    <p class="text-muted">Welcome back! Log in to access your assigned routes and trip details.</p>
                </div>
                ...
                <form action="../auth/login.php" method="post">
                    ...
                    <div class="mb-3">
                        <label for="username" class="form-label">Driver ID</label>
                        <div class="input-group">
                            <span class="input-group-text"><i class="fas fa-id-card"></i></span>
                            <input type="text" class="form-control" id="username" name="username" placeholder="Enter your driver ID" required>
                        </div>
                    </div>
                    <div class="mb-3">
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            inputGroups.forEach(group => {
                ...
                input.addEventListener('focus', () => {
                    group.style.boxShadow = '0 5px 15px rgba(76, 201, 240, 0.15)';
                });
